                ...
                <div class="form">
                  ...
                  action="{{ isset($pengalaman_kerja) ? route('pengalaman_kerja.update',$pengalaman_kerja->id) : route('pengalaman_kerja.store') }}" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" type="text" name="nama" id="nama" minlenght="5"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        ...
                        id="jabatan" minlenght="2" value="{{ isset($pengalaman_kerja) ? $pengalaman_kerja->jabatan : ''}}" require />
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="curl" class="control-label col-lg-2">Tahun Masuk <span class="require">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" type="text" name="tahun_masuk" id="tahun_masuk"
                        value="{{ isset($pengalaman_kerja) ? $pengalaman_kerja->tahun_masuk : ''}}" require />
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        ...
                        value="{{ isset($pengalaman_kerja) ? $pengalaman_kerja->tahun_keluar : ''}}" require />
                      </div>
                    </div>
                    <div class="form-group">
